...
connection_str = 'Endpoint=sb://eventhubchiran.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=yFWFqt/Ge4JtpNB2np7cXBJGHkPceRYyjNdmbl6Tv+8='
eventhub_name = 'airlineeventhub'
...
def main():
    with open(r'C:\Users\16477\Desktop\Project pro\Projects_AZURE\Learn to Create Delta Live Tables in Azure Databricks\Data\ONTIME_REPORTING_03.csv', 'r') as airline_desc:
